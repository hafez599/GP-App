...
# from Configs.ProcessingContext import ProcessingContext
# from Configs.TranscriptionConfig import TranscriptionConfig
...
#             print(
#                 f"Translation failed for segment {segment.get('index', 'unknown')}: {e}")
#             return {**segment, "text": "[Translation Error]"}

#     def translation_worker(self, translation_queue: Queue, context: ProcessingContext):
...
#                 break
#             translated_segment = self.translate_segment(segment_to_translate)
...
#     def process_video_with_streaming(self, context: ProcessingContext, config: TranscriptionConfig):
...
#                 args=(translation_queue, context)
#             )
